                ...
                <tbody>
                    <?php foreach ($registros as $row): ?>
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="index.php?controller=catalogo&action=editDocumentos&id=<?= $row['IdCatalogo'] ?><?= $selectedYear !== null ? '&year=' . (int)$selectedYear : '' ?>" class="btn btn-sm btn-primary">Editar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
